...
RadioToken = 'MTIzMTY4OTgyMjc0NjE4MTgwNg.GNjLIA.MliJIM-5nh8vLo574CX282pKFOO8XcldRqGGDI'
#SocialToken = 'MTIzMjAxNDY0ODY0NDIwNjcxNA.GOABQX.79yTCCLpXlsP7JhR8iV0F3PFMgZxaX7BG5gx3A'
SocialToken = 'MTIyNzcxNjYzODYzNjM4MDIwMA.GjBeDV.OZZknf4v3t7yWwSkU_8y5ObYzjEkuYUcLucwTI'
...
social_cogs = ['auto_posts', 'posts', 'collections', 'account_info']
economy_cogs = ['store']
